...
export class FighterController {
  ...
  @Get(':fighterId/fight-statistics')
  async getFightStatistics(@Param('fighterId') fighterId: number) {
    const fightStatistics = await this.fighterService.getFightStatistics(
      fighterId,
    );
